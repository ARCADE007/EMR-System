...
class DrDashboardStafftoRecordDashboardStaff extends React.Component {
  componentDidMount() {
          ...
          >
            <Container>
              ...
              >
                ...
                <NavbarBrand
                  to={`/RecordDashboardStaff/${this.props.patientId}`}
                  tag={Link}
                  className="nav-link-icon"
                >
                  <i className="ni ni-ui-04 d-lg-none mr-1" />
...
export default DrDashboardStafftoRecordDashboardStaff;
